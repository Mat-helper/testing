            ...
            <GridItem xs={12} sm={12} md={12}>
              ...
              <div className="create_box_panel row connect_row">
                <div className="col-12 col-sm-6 col-lg-4 mb-3">
                  <Link to="/create-single" className="create_box connect_wallet_box">
                    <h2>Metamask</h2>
                ...
                <div className="col-12 col-sm-6 col-lg-4 mb-3">
                  <Link to="/create-multiple" className="create_box connect_wallet_box">
                    ...
                    <p className="mb-0 text-center mt-3">Connect with your Google, Facebook, Twitter or Discord</p>
                ...
                <div className="col-12 col-sm-6 col-lg-4 mb-3">
                  <Link to="/create-multiple" className="create_box connect_wallet_box">
                    ...
                    <p className="mb-0 text-center mt-3">Connect with your email and password</p>
                ...
                <div className="col-12 col-sm-6 col-lg-4 mb-3">
                  <Link to="/create-multiple" className="create_box connect_wallet_box">
                    ...
                    <p className="mb-0 text-center mt-3">Connect via app on your phone</p>
